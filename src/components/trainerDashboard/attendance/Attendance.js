...
const Attendance = () => {
  ...
  const handleTakeAttendance = () => history.push("/trainer-dashboard/attendance/take-attendance");
  const handleViewAttendance = () => history.push("/trainer-dashboard/attendance/view-attendance");
